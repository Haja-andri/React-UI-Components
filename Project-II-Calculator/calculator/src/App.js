...
const App = () => {
  return (
    <div className="mainContainer">
      <div className="row">
        <RowChild className="row-child full" text="0" />
      </div>
      <div className="row">
        <RowChild className="row-child TF" text="clear" />
        <RowChild className="row-child forth" text="/" bkg="red"/>
      </div>      
      <div className="row">
        ...
        <RowChild className="row-child forth" text="X" bkg="red" />
      </div>      
      <div className="row">
